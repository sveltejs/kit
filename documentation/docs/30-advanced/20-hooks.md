...
You can define multiple `handle` functions and execute them in a middleware-like pattern with [the `sequence` helper function](/docs/modules#sveltejs-kit-hooks).

...
The object you return here becomes the body of an [expected error](errors#Expected-errors), which means it subsequently passes through [`handleError`](hooks#handleError) as an error with `kind: 'app'`.

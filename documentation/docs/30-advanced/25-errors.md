...
You can add your own error handling — for example, sending errors to a reporting service, or returning a custom error object — using the [`handleError`](/docs/hooks#shared-hooks-handleerror) hook.

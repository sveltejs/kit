...
Code imported with static `import` declarations will be automatically bundled with the rest of your page. If there is a piece of code you want to lazy load or need only when some condition is met, use the dynamic import form instead: `await import(...)`.

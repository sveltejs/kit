...
- Choose one image per page that is above the fold and the most important (or largest) and give it `fetchpriority="high" decoding="sync" loading="eager"` so it loads as early as possible. This gives you better web vitals scores (largest contentful paint, in particular).

...
- [`@sveltejs/adapter-zerops-node`](adapter-zerops-node) for [Zerops](https://zerops.io)
- [`@sveltejs/adapter-zerops-static`](adapter-zerops-static) for [Zerops](https://zerops.io)

...
- The SvelteKit repo contains [the SvelteKit site](https://github.com/sveltejs/kit/tree/master/sites/kit.svelte.dev) and a [HackerNews clone](https://github.com/sveltejs/kit/tree/master/sites/hn.svelte.dev)
- [`sveltejs/sites`](https://github.com/sveltejs/sites) contains the code for [svelte.dev](https://github.com/sveltejs/sites/tree/master/sites/svelte.dev)

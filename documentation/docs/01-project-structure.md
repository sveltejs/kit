...
Contains [configuration](https://vitejs.dev/config/) for the [Vite](https://vitejs.dev/). It use [SvelteKit Vite plugins](https://kit.svelte.dev/docs/modules#sveltejs-kit-vite).

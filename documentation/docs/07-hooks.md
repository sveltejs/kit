...
Those files can also be used to run code at the start of the application. This can be useful for running initialization code for database clients or various other libraries.

...
You can also use `adapter-static` to generate single-page apps (SPAs) by specifying a [fallback page](https://github.com/sveltejs/kit/tree/master/packages/adapter-static#spa-mode) and disabling SSR as page option (see [`SSR and SPA`](/docs/page-options#ssr-and-spa))

...
- [`packages/kit/src/vite/dev/index.js`](https://github.com/sveltejs/kit/blob/master/packages/kit/src/vite/dev/index.js) - for the dev-mode server
- [`packages/kit/src/vite/build/build_server.js`](https://github.com/sveltejs/kit/blob/master/packages/kit/src/vite/build/build_server.js) - for the production build

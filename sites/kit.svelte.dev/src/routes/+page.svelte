<script>
	...
	onMount(async () => {
		try {
			...
			// This warning will happen in IE11 if `schema_url` is an inline "data:..." URL
			//  (generated by Vite `?url` asset import resolvers).
			console.warn("Warning: Cannot load Google Schema file.");
		}
	});
</script>

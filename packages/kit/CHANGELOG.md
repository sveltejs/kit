...
- breaking: the `delta` property now only exists for `popstate` navigation events ([#15311](https://github.com/sveltejs/kit/pull/15311))
...
- chore: change `error`, `isHttpError`, `redirect`, and `isRedirect` to refer to public type instead of internal class ([#15311](https://github.com/sveltejs/kit/pull/15311))
...
- breaking: `svelte.config.js` will now be included in type checking ([#15311](https://github.com/sveltejs/kit/pull/15311))

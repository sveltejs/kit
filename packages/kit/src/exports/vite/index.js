			...
			: {
					filter: {
						id: [
							...
							// TODO: remove the cwd portion of this check? https://github.com/sveltejs/kit/issues/12529
							...
							new RegExp(
								`^${reg_exp_escape(normalized_cwd)}(?!${reg_exp_escape(normalized_node_modules)})${server_only_pattern.source}$`
							)
						]
					},
					handler(id, options) {

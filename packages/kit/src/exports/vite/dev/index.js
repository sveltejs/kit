 ...
 */
export async function dev(vite, vite_config, svelte_config, dev_environment) {
	installPolyfills();
	...
	async function update_manifest() {
		...
		for (const node of manifest_data.nodes) {
			if (node.universal) {
				...
				node_page_options.set(node.universal, page_options);
			}
		}

 ...
 * [`error`](https://svelte.dev/docs/kit/errors#Expected-errors) helper), errors generated by
 * SvelteKit itself (such as 404s), and unknown errors (thrown by your code, or code it calls).
 */
 ...
 *
 * The `kind` property discriminates between _app_ errors (thrown with the [`error`](https://svelte.dev/docs/kit/errors#Expected-errors) helper),

...
function generate_app(manifest_data, base) {
	...
	return trim(`
		...
		<script>
			...
			const i18n = writable({ 
				defaultLocale: ${manifest_data.i18n ? s(manifest_data.i18n.defaultLocale) : 'undefined'},
				locales: [${manifest_data.i18n?.locales.map((locale) => s(locale)).join(', ') || ''}] 
			});
			setContext('__svelte_i18n__', i18n);

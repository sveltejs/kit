	...
	assert.equal(routes.map(simplify_route), [
		{
			id: '/',
			pattern: '/^/$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 2 }
		},
		{
			id: '/about',
			pattern: '/^/about/?$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 3 }
		},
		{
			id: '/blog.json',
			pattern: '/^/blog.json/?$/',
		...
		},
		{
			id: '/blog',
			pattern: '/^/blog/?$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 4 }
		},
		{
			id: '/blog/[slug].json',
			pattern: '/^/blog/([^/]+?).json/?$/',
		...
		},
		{
			id: '/blog/[slug]',
			pattern: '/^/blog/([^/]+?)/?$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 5 }
		}
	]);
});
	...
	assert.equal(routes, [
		{
			id: '/',
			pattern: '/^/$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 1 }
		},
...
test('creates routes with layout', () => {
	...
	assert.equal(routes.map(simplify_route), [
...

		{
			id: '/foo',
			pattern: '/^/foo/?$/',
			page: { layouts: [0, 2], errors: [1, undefined], loading: [undefined, undefined], leaf: 4 }
		}
	]);
});
	...
	assert.equal(routes.map(simplify_route), [
		...
		},
		{
			...
			page: {
				...
				loading: [undefined, undefined, undefined, undefined],
				leaf: 6
			}
		}
	]);
	...
	assert.equal(routes.filter((route) => route.page).map(simplify_route), [
		{
			id: '/a/a1',
			pattern: '/^/a/a1/?$/',
			page: { layouts: [0, 4], errors: [1, undefined], loading: [undefined, undefined], leaf: 10 }
		},
		{
			id: '/(special)/a/a2',
			pattern: '/^/a/a2/?$/',
			page: { layouts: [0, 2], errors: [1, undefined], loading: [undefined, undefined], leaf: 9 }
		},
		{
			...
			page: {
				...
				loading: [undefined, undefined, undefined],
				leaf: 8
			}
		},
		{
			id: '/b/c/c2',
			pattern: '/^/b/c/c2/?$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 11 }
		},
		{
			id: '/b/d/(special)',
			pattern: '/^/b/d/?$/',
			page: { layouts: [0, 6], errors: [1, undefined], loading: [undefined, undefined], leaf: 12 }
		},
		{
			id: '/b/d/d1',
			pattern: '/^/b/d/d1/?$/',
			page: { layouts: [0], errors: [1], loading: [undefined], leaf: 15 }
		},
		{
		...
		},
		{
			...
			pattern: '/^/b/d/d3/?$/',
			page: { layouts: [0, 6], errors: [1, undefined], loading: [undefined, undefined], leaf: 14 }
		}
	]);
});
...
test('handles pages without .svelte file', () => {
	...
	assert.equal(routes.map(simplify_route), [
		...
		},
		{
			id: '/error/[...path]',
			pattern: '/^/error(?:/(.*))?/?$/',
			page: { layouts: [0, undefined], errors: [1, 2], loading: [undefined, undefined], leaf: 6 }
		},
		{
			id: '/layout',
			pattern: '/^/layout/?$/'
		...
		},
		{
			...
			page: { layouts: [0, 3], errors: [1, undefined], loading: [undefined, undefined], leaf: 8 }
		}
	]);
});

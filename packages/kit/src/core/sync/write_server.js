...
import { set_manifest, set_read_implementation, set_upgrade_implementation } from '__sveltekit/server';
...
export { set_assets, set_building, set_manifest, set_prerendering, set_private_env, set_public_env, set_read_implementation, set_upgrade_implementation, set_safe_public_env };
`;

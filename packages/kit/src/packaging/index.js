...
async function try_load_svelte2tsx() {
	...
	async function load() {
		try {
			...
			throw new Error(
				'You need svelte2tsx and typescript if you want to generate type definitions. Install it through your package manager, or disable generation which are highly discouraged. See https://kit.svelte.dev/docs#packaging'
			);
		}
	}
}

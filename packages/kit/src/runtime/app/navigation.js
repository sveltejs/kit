 ...
 *
 * @type {<S>(url: S extends string ? import('@sveltejs/kit').MatchedLeafs<S> extends { matched: any } ? S : import('@sveltejs/kit').Equals<S, string> extends true ? S : `no matched routes with id: ${S}` : string | URL, opts?: {

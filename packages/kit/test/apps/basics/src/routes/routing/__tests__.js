...
export default function (test) {
	...
	test(
		...
		'/routing',
		async ({ app, capture_requests, page, click, js }) => {
			if (js) {
	...
	test('resets the active element after navigation', '/routing', async ({ page, click }) => {
	...
	test('navigates to ...rest', '/routing/abc/xyz', async ({ page, click }) => {
	...
	test('find regexp routes', '/routing/qwe', async ({ page, click }) => {

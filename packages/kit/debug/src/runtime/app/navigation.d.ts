 ...
 * @type {(callback: (navigation: import('@sveltejs/kit').OnNavigate) => import('../../types/internal.d.ts').MaybePromise<(() => void) | void>) => void}
 * @param {(navigation: import('@sveltejs/kit').OnNavigate) => void} callback
 * @returns {void}
 */
export const onNavigate: (callback: (navigation: import('@sveltejs/kit').OnNavigate) => import('../../types/internal.d.ts').MaybePromise<(() => void) | void>) => void;
/**

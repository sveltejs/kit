...
declare module '$app/navigation' {
	 ...
	 * @param opts Optional. If `replaceState` is `true`, a new history entry won't be created. If `noscroll` is `true`, the browser won't scroll to the top of the page after navigation. If `keepfocus` is `true`, the browser won't focus the body element / unfocus the current element. If state is set, its value will be used to set the initial state of the new history entry, which defaults to `{}`
	 */

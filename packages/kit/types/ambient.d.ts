...
declare module '$service-worker' {
	/**
	 * An array of URL strings representing the files generated by Vite. You can customize which files are included using [`config.kit.serviceWorker.filters.build`](https://kit.svelte.dev/docs/configuration#serviceworker), which can make the array suitable for caching with `cache.addAll(build)`.
	 */
	export const build: string[];
	/**
	 * An array of URL strings representing the files in your static directory, or whatever directory is specified by `config.kit.files.assets`. You can customize which files are included using [`config.kit.serviceWorker.filters.files`](https://kit.svelte.dev/docs/configuration#serviceworker)
	 */
	export const files: string[];
	/**
	 * An array of pathnames corresponding to prerendered pages and endpoints. You can customize which files are included using [`config.kit.serviceWorker.filters.prerendered`](https://kit.svelte.dev/docs/configuration#serviceworker)
	 */

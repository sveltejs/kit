...
export interface KitConfig {
	...
	appDir?: string;
	/**
	 * Path to the tsconfig file that the autogenerated sveltekit tsconfig should extend. This is useful if you want to extend a custom tsconfig for your project.
	 */
	extends?: string;
	/**

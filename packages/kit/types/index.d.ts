...
export interface Config {
	...
	/**
	 * Path to a tsconfig file to extend, relative to the project root.
	 */
	extends?: string;
	/**
...
export interface KitConfig {
	...
	/**
	 * Path to the tsconfig file, relative to the project root, that the autogenerated sveltekit tsconfig should extend. This is useful if you want to extend a custom tsconfig for your project.
	 * @default undefined
	 */
	extends?: string;
	/**

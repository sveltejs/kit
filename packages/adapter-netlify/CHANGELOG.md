...
- 4cb4e749: update build output locations ([https://github.com/sveltejs/kit/pull/2058](#2058))
...
- 67ca3a39: return the correct headers ([https://github.com/sveltejs/kit/pull/1913](#1913))

## 1.0.0-next.22

### Patch Changes

- 9461178: Use multivalue headers to set multiple cookies ([https://github.com/sveltejs/kit/pull/1906](#1906))
...
- 3b988a4: Allow `_redirects` to be placed in root directory ([https://github.com/sveltejs/kit/pull/1586](#1586))
...
- d3cb858: Convert body to string, unless type is octet-stream ([https://github.com/sveltejs/kit/pull/1121](#1121))
...
- 1237eb3: Pass rawBody from netlify adapter ([https://github.com/sveltejs/kit/pull/1109](#1109))
...
- 0db2cf7: Fix serverless function ([https://github.com/sveltejs/kit/pull/1102](#1102))
...
- 512b8c9: adapter-netlify: Use CJS entrypoint ([https://github.com/sveltejs/kit/pull/485](#485))
